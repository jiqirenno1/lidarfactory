//
// Created by ubuntu on 2020/12/1.
//
...
main (int argc, char*argv[])
{
    ...
    pcl::io::loadPCDFile ("/home/ubuntu/lidar/plane.pcd", *cloud);
...
//    }
    ...
    for (size_t i = 0; i < cloud ->points.size (); ++i) {
        if ( Sigma [i] > ( MinD + ( 200* step) ) ) {  //6*step
//            cloud->points[i].r = 255;
//            cloud->points[i].g =  0 ;
//            cloud->points[i].b =  0;
           line->points.push_back(cloud->points[i]);
...
//	    	                    }
    ...
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> r(line, 0, 255, 0);
